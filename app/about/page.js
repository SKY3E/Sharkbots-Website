  ...
  return (
    <article>
      ...
      <section className='background-section py-8 px-4 mx-8 rounded'>
        <h2 className='text-white font-extrabold text-4xl'>How did we get together?</h2>
        <br></br>
      ...
      <Divider color={"white"} />
      <section className='background-section py-8 px-4 mx-8 rounded'>
        <h2 className='text-white font-extrabold text-4xl'>How did last year go?</h2>
        <br></br>
        <p className='text-white text-xl'>
      ...
      <Divider color={"white"} />
      <section className='background-section py-8 px-4 mx-8 rounded'>
        <h2 className='text-white font-extrabold text-4xl'>What's planned this year?</h2>
        <br></br>
        <p className='text-white text-xl'>
