  ...
  return (
    <article>
      ...
      <section className='flex justify-around'>
        <img className='object-cover height-rsection w-full mr-4 rounded-r-lg' src='/Team.jpg'></img>
      ...
      <section className='flex justify-around'>
        ...
        <img className='object-cover height-rsection w-full ml-4 rounded-l-lg' src='/JohnJay.jpg'></img>
      </section>
      <Divider color={"white"} />
      <section className='flex justify-around'>
        <img className='object-cover height-rsection w-full mr-4 rounded-r-lg' src='/Team.jpg'></img>
